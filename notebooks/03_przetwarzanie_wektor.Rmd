...
Wybierz dowolne województwo i stwórz dwie mapy dla powiatów przedstawiające
średnią oraz odchylenie standardowe wysokości terenu. Jako rozwiązanie zadania
przygotuj powtarzalny skrypt.
...
nagłówek kolumn oraz typ kolumn. W przypadku dużych zbiorów danych, można
przeprowadzić analizę na losowej próbie.
